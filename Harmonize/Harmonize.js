...
var WeakMapStoreFactory = (function(WeakMap) {
	...
	return (function() {
		...
		var storageGenerators = {
				'WeakMap': WeakMapStoreFactory && WeakMapStoreFactory.create,
...
if (typeof module == 'object' && typeof module.exports == 'object')
	module.exports = Secrets;;
		...
		forEach = lazyBind(Array.prototype.forEach),
		every = lazyBind(Array.prototype.every),
		...
		Secrets = (function() {
			var $ = createSecret(),
				SecretsMethods = {
					...
					getOwn: function getOwn(name) {
						return hasOwn(this.store, name) ? this.store[name] : undefined;
					},
...
var WeakMap = (function() {
	...
	defineValuesWC(WeakMap.prototype, {
		...
		set: function set(key, value) {
			...
			// [We deviate from the steps to keep the weak, O(1) intent of the WeakMap.]
			if (setRecord(S, key, p) === NO_SECRETS) {
				// [If the weak intent cannot be kept, we fall back to non-weak, O(n) steps.]
